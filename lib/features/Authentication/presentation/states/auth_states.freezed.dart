...
abstract class $AuthStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({bool isLoading, BusinessModel? businessModel});
...
class _$AuthStateImpl implements _AuthState {
  _$AuthStateImpl({required this.isLoading, required this.businessModel});
  ...
  @override
  String toString() {
    return 'AuthState(isLoading: $isLoading, businessModel: $businessModel)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, isLoading, businessModel);
...
abstract class _AuthState implements AuthState {
  factory _AuthState(
      ...
      required final BusinessModel? businessModel}) = _$AuthStateImpl;
